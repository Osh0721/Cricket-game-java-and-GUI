...
public class KandyvsUthura {
    @FXML
    TextArea TEST;
    public void KandyvsUthura () {

        String First_Team = "Kandy tuskers";
        String Second_Team = "Uthura Riders";

        String[] KandyPlayers = {"Oshan", "Bhathiya", "Pandula", "Isitha", "Aluwa", "lahiru", "Uditha", "hasindu", "Wishawa", "Janitha", "Charitha"};

        String[] Uthuraplayer = {"pasindu", "denidu", "Thisanka", "sanga", "mahela", "sanath", "chamika", "malinga", "hasaranga", "abekoon","Theshan"};


        String player = KandyPlayers[0];
        ...
        TEST.appendText("First batman is " + KandyPlayers[0] + "\n");
            ...
            for (int i = 0; i < 6; i++) {
                ...
                if (Ball == 0) {
                    ...
                    if (Wicket < 10) {
                        ...
                        player_position += 1;
                        player = KandyPlayers[player_position];
        ...
        for (int b = 0; b < KandyPlayers.length; b++) {
            Double currentWicket = Math.floor(Math.random() * 7);
            if (currentWicket < AvaWicket) {
                Wicket_ballers1.put(KandyPlayers[b], currentWicket);
                AvaWicket -= currentWicket;
            } else {
                Wicket_ballers1.put(KandyPlayers[b], (double) AvaWicket);
                AvaWicket = 0;
            }
        ...
        TEST.appendText("First batman is " + Uthuraplayer[0] + "\n");
            ...
            for (int i = 0; i < 6; i++) {
                ...
                if (Ball == 0) {
                    ...
                    if (Wicket < 10) {
                        ...
                        player_position += 1;
                        player = Uthuraplayer[player_position];
                        TEST.appendText("Next bat man is " + player + "\n");
        ...
        AvaWicket = Wicket;
        for (int b = 0; b < Uthuraplayer.length; b++) {
            Double currentWicket = Math.floor(Math.random() * 7);
            if (currentWicket < AvaWicket) {
                Wicket_ballers2.put(Uthuraplayer[b], currentWicket);
                AvaWicket -= currentWicket;
            } else {
                Wicket_ballers2.put(Uthuraplayer[b], (double) AvaWicket);
                AvaWicket = 0;
            }

...
public class ChennaivsMumbai {
    @FXML
    TextArea TEST;
    public void ChennaivsMumbai() {

        String First_Team = "Chennai super kings";
        String Second_Team = "Mumbai indians";
        ...
        for (int b = 0; b < MumbaiPlayers.length; b++) {
            Double currentWicket = Math.floor(Math.random() * 7);
            if (currentWicket < AvaWicket) {
                Wicket_ballers2.put(MumbaiPlayers[b], currentWicket);
                AvaWicket -= currentWicket;
            } else {
                Wicket_ballers2.put(MumbaiPlayers[b], (double) AvaWicket);
                AvaWicket = 0;
            }

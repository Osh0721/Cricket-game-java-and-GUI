...
public class RajasthanvsKolkata {
    @FXML
    TextArea TEST;
    public void RajsathanvsKolkata(){
        String First_Team = "Rajasthan Royals";
        String Second_Team = "Kolkata";
        ...
        String player = RajasthanPlayers [0];
        ...
        for (int b = 0; b < RajasthanPlayers .length; b++) {
            ...
            if (currentWicket < AvaWicket) {
                Wicket_ballers1.put(KolkataPlayers  [b], currentWicket);
                AvaWicket -= currentWicket;
            } else {
                Wicket_ballers1.put(KolkataPlayers  [b], (double) AvaWicket);
                AvaWicket = 0;
            }
